...
-- case use -- 
    ...
    from clientes join pedidos join produtos join pagamentos join entregas join itensPedidos
    on clientes.cliente_id = pedidos.fk_cliente_id && 
    itensPedidos.itensPedidos_id = pedidos.fk_itensPedidos_id &&
    entregas.entrega_id = itensPedidos.fk_entrega_id &&
    pagamentos.pagamento_id = itensPedidos.fk_pagamento_id &&
    produtos.produto_id = itensPedidos.fk_produto_id;
    
    -- Como o cliente pagou a compra --
    select clientes.nomeCliente,pagamentos.*
    from clientes join pedidos join pagamentos join itensPedidos
    on clientes.cliente_id = pedidos.fk_cliente_id && 
    itensPedidos.itensPedidos_id = pedidos.fk_itensPedidos_id &&
    pagamentos.pagamento_id = itensPedidos.fk_pagamento_id;
    ...
    from clientes join pedidos join produtos join itensPedidos
    on clientes.cliente_id = pedidos.fk_cliente_id && 
    itensPedidos.itensPedidos_id = pedidos.fk_itensPedidos_id &&
     produtos.produto_id = itensPedidos.fk_produto_id;
    ...
    from clientes join pedidos join itensPedidos join entregas join transportadoras
    on clientes.cliente_id = pedidos.fk_cliente_id && 
    itensPedidos.itensPedidos_id = pedidos.fk_itensPedidos_id &&
    entregas.entrega_id = itensPedidos.fk_entrega_id &&
    transportadoras.transportadora_id = entregas.fk_transportadora_id;